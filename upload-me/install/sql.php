...
$arr['sql'][] = 'SET SQL_MODE = "NO_AUTO_VALUE_ON_ZERO";';
$arr['sql'][] = 'SET time_zone = "+00:00";';
...
--
*/
$arr['sql'][] = "CREATE DATABASE IF NOT EXISTS `hosting` DEFAULT CHARACTER SET utf8 COLLATE utf8_general_ci;";
$arr['sql'][] = "USE `hosting`;";
...
$arr['sql'][] = "CREATE TABLE IF NOT EXISTS `box` (
...
$arr['sql'][] = "CREATE TABLE IF NOT EXISTS `game` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `name` varchar(80) NOT NULL,
...
--
*/
$arr['sql'][] = "CREATE TABLE IF NOT EXISTS `general` (
...
--
*/
$arr['sql'][] = "CREATE TABLE IF NOT EXISTS `ip` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
...
--
*/
$arr['sql'][] = "CREATE TABLE IF NOT EXISTS `logs_actions` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
...
--
*/
$arr['sql'][] = "CREATE TABLE IF NOT EXISTS `logs_status` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
...
--
*/
$arr['sql'][] = "CREATE TABLE IF NOT EXISTS `logs_users` (
...
--
*/
$arr['sql'][] = "CREATE TABLE IF NOT EXISTS `news` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `news` text NOT NULL,
...
--
*/
$arr['sql'][] = "CREATE TABLE IF NOT EXISTS `packages` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
...
--
*/
$arr['sql'][] = "CREATE TABLE IF NOT EXISTS `server` (
...
--
*/
$arr['sql'][] = "CREATE TABLE IF NOT EXISTS `users` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `lang` varchar(10) NOT NULL DEFAULT '',
